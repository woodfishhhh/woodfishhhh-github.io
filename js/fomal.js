...
$.ajax({
  ...
  data: {
    key: 'A4UBZ-53O63-KGD3V-R4TSU-MWNRK-OGF4X',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function getWeibo() {
  fetch('325421c6bed329eef16420b0c73b787c').then(data => data.json()).then(data => {  // 这里要写上你的API!!!
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    ...
    --mobileday-bg: url(https://pic1.imgdb.cn/item/682f3d1458cb8da5c807b6fa.jpg);
    --mobilenight-bg: url(https://pic1.imgdb.cn/item/682f3d1458cb8da5c807b6fa.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
